...
- `Prefer Spotify Links`: resolve Last.fm track links to Spotify URIs in the background. When enabled, clicking a Last.fm track navigates to Spotify instead of Last.fm.
